...
implements ActionListener, MouseListener {
	...
	private void buildPanel() {
		...
		//按钮
		bt1 = new TJButton("pic/modi3.gif", " 确 定 ", "开单");//按钮名是确定，气泡提示是开单
